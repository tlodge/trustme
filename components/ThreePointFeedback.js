...
const ThreePointFeedback = ({answers, previous, selected, clicked, width=SVGHEIGHT, height=SVGHEIGHT}) => {
    ...
    const renderLabels = (index)=>{
        return <g>
            ...
            <text x={75} y={79} className={styles.label}    style={{opacity: index==2  ? 1.0 : 0.4}}  transform="rotate(-60,65,78)">why</text>
            <text x={110} y={140} className={styles.label} style={{opacity: index==1 ? 1.0 : 0.4}}  transform="rotate(0,150,80)">how</text>
        </g>
    }
    ...
    return     <svg  onClick={clicked} width={width} height={height} viewBox="0 0 150 150" className={styles.trianglesvg}>
                    ...
                    <g transform="translate(-33,5)">
                        ...
                        <g id="bigtriangle">
                            <path d="M45.884,127.352L109.629,17.053L172.902,127.352L45.884,127.352Z" className={styles.outertriangle} style={{stroke: selected ? "white": "none"}}/>
                        </g> 
